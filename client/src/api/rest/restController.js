...
export const getContests = (data) => http.post('newgetContests', data)
export const getAllUsers = (data) => http.post('getAllUsers', data)
export const getOffers = (data) => http.post('getOffers', data)
export const addNewContest = (data) => http.post('addNewContest', data)
export const addNewOffer = (data) => http.post('addNewOffer', data)
export const updatePassRequest = (data) => http.post('updatePass', data)
export const recoverysRequest = (data) => http.post('recovery', data);
