export default {
    ...
    ADD_NEW_CONTEST_EVENT: 'ADD_NEW_CONTEST_EVENT',
    ADD_NEW_CONTEST_SUCCESS: 'ADD_NEW_CONTEST_SUCCESS',
    ADD_NEW_CONTEST_ERROR: 'ADD_NEW_CONTEST_ERROR',
    ADD_NEW_OFFER_EVENT: 'ADD_NEW_OFFER_EVENT',
    ADD_NEW_OFFER_SUCCESS: 'ADD_NEW_OFFER_SUCCESS',
    ADD_NEW_OFFER_ERROR: 'ADD_NEW_OFFER_ERROR',
    ACTION_UPDATE_PASS: 'ACTION_UPDATE_PASS',
    AUTH_ACTION_PASS_RECOVERY: 'AUTH_ACTION_PASS_RECOVERY',
