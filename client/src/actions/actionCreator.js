...
export const addNewContest = (data) => {
    return {
        type: ACTION.ADD_NEW_CONTEST_EVENT,
        data: data
    }
}
...
export const addNewOffer = (data) => {
    return {
        type: ACTION.ADD_NEW_OFFER_EVENT,
        data: data
    }
}
...
export const updatePass = (data) => {
    return {
        type: ACTION.ACTION_UPDATE_PASS,
        data: data
    }
}

export const authActionPassRecovery = (data) => {
    return {
        type: ACTION.AUTH_ACTION_PASS_RECOVERY,
        data: data
    }
}
